...
class StudentsTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ...
            ->maxLength('matrix_number', 20)
            ->requirePresence('matrix_number', 'create')
            ->notEmptyString('matrix_number')
            ->add('matrix_number', 'unique', ['rule' => 'validateUnique', 'provider' => 'table']);
        ...
        $validator
            ->scalar('qr_code_path')
            ->maxLength('qr_code_path', 255)
            ->allowEmptyString('qr_code_path');
    ...
    {
        $rules->add($rules->isUnique(['matrix_number']), ['errorField' => 'matrix_number']);
